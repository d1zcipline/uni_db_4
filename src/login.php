          ...
          <div class="card-body">
            ...
            <div class="mb-4">
              ...
              <ul class="small text-muted">
                <li><strong>Администратор</strong> — полный доступ к настройкам системы: создание новых пользователей, формирование расписаний маршрутов.</li>
                <li><strong>Диспетчер</strong> — управление текущими рейсами и оперативное внесение изменений в расписание.</li>
                <li><strong>Водитель</strong> — доступ к своему личному кабинету: просмотр назначенных рейсов и расписания.</li>
              </ul>
            </div>
