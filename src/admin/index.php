...
<body>
  ...
  <div class="container my-5">
    ...
    <div class="row">
      ...
      <div class="col-md-4 mb-4">
        <div class="card h-100">
          <div class="card-header bg-warning text-white">Сотрудники</div>
          <div class="card-body">
            <p>Управление водителями и диспетчерами</p>
            <a href="admin/admin_employees.php" class="btn btn-warning">Перейти</a>
          </div>
        </div>
      </div>
    </div>
